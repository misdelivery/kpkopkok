...
model = MambaForCausalLM.from_pretrained('kotoba-tech/kotomamba-2.8B-CL-v1.0', config=mamba_config, low_cpu_mem_usage=True)

model.save('misdelivery/kotomamba-2.8B-CL-v1.0-hf')
tokenizer.save("misdelivery/kotomamba-2.8B-CL-v1.0-hf")
